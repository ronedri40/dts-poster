...
\setbeamertemplate{headline}{
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.29\paperwidth}
      \includegraphics[width=\linewidth]{stein_logo.png}
    \end{column}
...
\begin{column}{0.49\linewidth}
  \centering\includegraphics[width=0.82\linewidth]{images/graphcoloring_convergence_cropped.pdf}
\end{column}
\hfill
\begin{column}{0.49\linewidth}
  \centering\includegraphics[width=0.82\linewidth]{images/graphcoloring_diversity_cropped.pdf}
\end{column}
\end{columns}
\vspace{2mm}
